...
# ── Config ──────────────────────────────────────────────────────────────
import os
GARMIN_EMAIL    = os.environ.get("GARMIN_EMAIL",    "rockymanghani@gmail.com")
GARMIN_PASSWORD = os.environ.get("GARMIN_PASSWORD", "Rakesh2001!!")
REDIS_URL       = os.environ.get("REDIS_URL",       "https://upward-clam-84813.upstash.io")
REDIS_TOKEN     = os.environ.get("REDIS_TOKEN",     "gQAAAAAAAUtNAAIncDE2ZDA0NTMzNzAwZWM0OTZhODc0OGE3NmVhNzE1Nzc4Y3AxODQ4MTM")
# ────────────────────────────────────────────────────────────────────────
